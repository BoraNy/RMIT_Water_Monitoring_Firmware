...
NPIC_logo = PhotoImage(file="img/NPIC.png")
...
temCircle = ttk.Meter(window, amounttotal=150  # --> Maximum Value
                      ...
                      , bootstyle=PRIMARY, interactive=False, textfont=["Arial", 26, 'bold'], textright="°C",
                      subtext="Temperature", subtextfont=["Arial", 15, "bold"])
...
turCircle = ttk.Meter(window, amounttotal=1000  # --> Maximum Value
                      ...
                      , metersize=250  # --> Radius of Circle
                      , meterthickness=20  # --> Width of Circle
                      , bootstyle=PRIMARY, interactive=False, textfont=["Arial", 26, 'bold'], textright="ppm",
                      subtext="TDS", subtextfont=["Arial", 15, "bold"])
...
phCircle = ttk.Meter(window, amounttotal=14  # --> Maximum Value
                     ...
                     , metersize=250  # --> Radius of Circle
                     , meterthickness=20  # --> Width of Circle
                     , bootstyle=PRIMARY, interactive=False, textfont=["Arial", 26, 'bold'], textright="PH",
                     subtext="pH", subtextfont=["Arial", 15, "bold"])
...
oxygenCircle = ttk.Meter(window, amounttotal=20  # --> Maximum Value for sensor is 20mg/L
                         ...
                         , metersize=250  # --> Radius of Circle
                         , meterthickness=20  # --> Width of Circle
                         , bootstyle=PRIMARY, interactive=False, textfont=["Arial", 26, 'bold'], textright="mg/l",
                         subtext="Oxygen", subtextfont=["Arial", 15, "bold"])
oxygenCircle.place(x=450, y=550)

# --> Quality Index
quality_logo = Canvas(window, width=800, height=100)
quality_logo.place(x=950, y=400)
Quality_logo = PhotoImage(file="img/Quality_Index.png")
